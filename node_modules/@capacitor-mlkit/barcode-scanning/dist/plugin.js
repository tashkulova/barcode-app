var capacitorBarcodeScanner = (function (exports, core) {
    ...
    class BarcodeScannerWeb extends core.WebPlugin {
        ...
        async readBarcodesFromImage(options) {
            ...
            const formats = (_a = options.formats) === null || _a === void 0 ? void 0 : _a.map(format => format.toLowerCase());
            const barcodeDetector = new BarcodeDetector((formats === null || formats === void 0 ? void 0 : formats.length) ? { formats } : undefined);
        ...
        convertDetectedBarcodesToBarcodes(barcodes) {
